    ...
    <div class="notepad-dlg-search">
      <div class="dialogbox notepad-dlgbox">
        ...
        <div class="main notepad-dlg-main">
          <label for="">查找内容(N):<input class="txt-content" type="text" autofocus></label><br>
          <label><input type="checkbox" value="capital-sense">区分大小写(C)</label>
          <br>
          <label><input type="checkbox" value="circulate">循环(R)</label>
  ...
  function show(searchHandler){
    ...
    $btnSearch.click(function(){
      searchHandler({
        ...
        circulate:$dlg.find('input[type="checkbox"]:checked').val()==='circulate',
